...
SIDO_LIST = {
    ...
    "서울": {
        ...
        "selector": "#move-cont1 > div:nth-of-type(4) > table.tstyle-status.pc.pc-table > tbody > tr:nth-of-type({}) > td",
    ...
    "부산": {
        ...
        "selector": "#covid-state-area > div.covid-state-table > table:nth-of-type(1) > tbody > tr:nth-of-type({}) > td:nth-of-type(n+2)",
    ...
    "인천": {
        ...
        "selector": "#content > div > div > div > div > div:nth-of-type(2) > div > table > tr:nth-of-type({}) > td:nth-of-type(n+2)",
    ...
    "울산": {
        ...
        "selector": "body > div.corona_wrap > div > div > div.localarea_box > table > tbody > tr:nth-of-type({}) > td:not(:first-of-type)",
        "sensor": (SELECTED_SENSORS([0,1]), [1, 2]),
        "attribute": {
            SENSORS_LIST[1]: (SELECTED_ATTIBUTE([0, 1, 2]), [3, 4, 1]),
        },
        "last_update": "body > div.corona_wrap > div > div > div:nth-of-type(1) > div.top_area > p"
    },
    "세종": {
        "city": [], 
        "url": ""
    ...
    "경기": {
        ...
        "sensor": (SELECTED_SENSORS([0,1]), ['small:nth-of-type(1)','strong:nth-of-type(1)']),
        "attribute": {
    ...
    "강원": {
        ...
        "selector": "table.skinTb > tbody > tr:nth-of-type(2n) > td:not([rowspan])",
    ...
    "경북": {
        ...
        "selector": "#container > div.corona_gb > dl:nth-of-type(n+2) > dd > span{}",
        "sensor": (SELECTED_SENSORS([0,1]), ['.today', '.total']),
        "last_update": "#container > h3:nth-child(1) > span"
    },
    "경남": {
        "city": ["창원", "진주", "통영", "사천", "김해", "밀양", "거제", "양산", "의령", "함안", "창녕", "고성", "남해", "하동", "산청", "함양", "거창", "합천"], 
        "url": "http://xn--19-q81ii1knc140d892b.kr/main/main.do",
        "selector": "#subCnt > div.cont.corona_map > div.city_board > div > div.table.type1.pt10 > table > tbody > tr:nth-of-type({}) > td:nth-of-type(n+2)",
        "sensor": (SELECTED_SENSORS([0,1]), [2, 1]),
        "last_update": "#subCnt > div:nth-of-type(3) > a > div > div.top_area > p.exp"
    },
    "제주": {
        "city": [], 
        "url": ""
