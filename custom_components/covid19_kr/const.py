...
SIDO_LIST = {
    ...
    "부산": {
        ...
        "selector": "#covid-state-area > div > div.covid-state-table > table:nth-of-type(1) > tbody > tr:nth-of-type({}) > td:nth-of-type(n+2)",
    ...
    "울산": {
        ...
        "selector": "body > div.corona_wrap > div > div > div.localarea_box > table > tbody > tr:nth-of-type({}) > td",
        "sensor": (SELECTED_SENSORS([0,1]), [1, 2]),
        "attribute": {
    ...
    "경북": {
        ...
        "selector": "#contents > div.status > div:nth-of-type(2) > div > dl:nth-of-type(n+3) > dd > {}",
        "sensor": (SELECTED_SENSORS([0,1]), ['span', 'strong']),
        "last_update": "#contents > div.status > div:nth-of-type(1) > div.status_tit > dl > dd"
    },
    "경남": {
        "city": ["창원", "진주", "통영", "사천", "김해", "밀양", "거제", "양산", "의령", "함안", "창녕", "고성", "남해", "하동", "산청", "함양", "거창", "합천"], 
        "url": "http://xn--19-q81ii1knc140d892b.kr/main/main.do",
        "selector": "#subCnt > div.cont.corona_map > div.city_board > div > div.table.type1.pt10 > table > tbody > tr:nth-of-type({}) > td:nth-of-type(n+3)",
